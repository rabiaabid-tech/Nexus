...
export const EntrepreneurProfile: React.FC = () => {
  ...
  const foundedYear = profile.foundedYear || profile.founded_year || "N/A";
  const teamSize = profile.teamSize || profile.team_size || 1;
  const pitchSummary =
    profile.pitchSummary ||
    profile.pitch_summary ||
    "No pitch summary provided yet.";
  const fundingNeeded =
